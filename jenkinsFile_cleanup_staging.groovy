...
API_CRED = 'b87c83da-2209-4958-9666-6a5b0e9a071b'
PUSH_BRANCH = 'master'
        ...
        node('worker') {
            try {
                ...
                stage("Cleanup") {
                    ...
                    withCredentials([string(credentialsId: 'b87c83da-2209-4958-9666-6a5b0e9a071b', variable: 'token')]) {
                        for (pr in prArray) {
                            retry(3) {
                                def prJSON = sh (returnStdout: true, script: "curl -u genie-openj9:${token} https://api.github.com/repos/eclipse/openj9-docs/pulls/${pr} 2>/dev/null").trim()
