...
|Stack size for OS Threads version 8 to 16 **(64-bit)**. Use `-Xmso<size>`           |512 KB    |256 KB (512 KB on PPC)    |256 KB           |256 KB           |1 MB      |:fontawesome-solid-check:{: .yes aria-hidden="true"}<span class="sr-only">yes</span>| :fontawesome-solid-times:{: .no aria-hidden="true"}<span class="sr-only">no</span> |
|Stack size for OS Threads version 17 and later **(64-bit)**. Use `-Xmso<size>`      |512 KB    |512 KB (256 KB on Z)      |512 KB           |512 KB           |1 MB      |:fontawesome-solid-check:{: .yes aria-hidden="true"}<span class="sr-only">yes</span>| :fontawesome-solid-times:{: .no aria-hidden="true"}<span class="sr-only">no</span> |
