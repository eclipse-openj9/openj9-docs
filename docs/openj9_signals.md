...
Signals that are used by the Eclipse OpenJ9&trade; VM include the following types:
...
On the z/OS&reg; platform, the pid is included in the tracepoint and reported in the javacore but the process name is not included. For example,
