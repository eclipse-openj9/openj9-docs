...
You can use the `maxstringlength` parameter of the `-Xtrace` option to print the string arguments sent to and the values that are returned from the methods as strings instead of addresses in a trace output.
