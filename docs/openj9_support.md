...
:fontawesome-solid-bell:{: .warn aria-hidden="true"} **Important:** From the 0.55.0 release onwards, AIX OpenJ9 builds require the [XL C++ Runtime 17.1.3.0 or later](https://www.ibm.com/support/pages/fix-list-xl-cc-runtime-aix#17130).
...
| macOS x86 64-bit              | macOS 10.15.7          | xcode 12.4 and clang 12.0.0           |
| macOS AArch64                 | macOS 11.5.2           | xcode 13.0 and clang 13.0.0           |
| AIX POWER BE 64-bit           | AIX 7.2 TL5            | xlc/C++ 17.1.3.0                   |
