...
This option controls whether a garbage collection cycle takes place when the state of the OpenJ9 VM is set to idle, and if compaction is required during the idle GC.
