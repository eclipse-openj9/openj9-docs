...
This option enables or disables OpenSSL native cryptographic support for the SHA-256 digest algorithm.

## Syntax

        -Djdk.nativeSHA256=[true|false]

| Setting              | value    | Default                                                                        |
|----------------------|----------|:------------------------------------------------------------------------------:|
| `-Djdk.nativeSHA256` | true     | :fontawesome-solid-check:{: .yes aria-hidden="true"}<span class="sr-only">yes</span> |
...
<!-- ==== END OF TOPIC ==== djdknativesha256.md ==== -->
